...
public class ContactManager {
    ...
    contacts.add(new Contact("Raksha R", "999-111-2222", "raksha@email.com", "12 MG Road", "Best Friend"));
    contacts.add(new Contact("Aarav Kumar", "888-222-3333", "aarav@email.com", "45 Lake View", "Office Colleague"));
    contacts.add(new Contact("Priya Sharma", "777-333-4444", "priya@email.com", "78 Rose Street", "Family"));
    contacts.add(new Contact("Nikhil Verma", "666-444-5555", "nikhil@email.com", "22 Palm Drive", "Gym Buddy"));
    contacts.add(new Contact("Sneha Patil", "555-777-8888", "sneha@email.com", "90 Green Park", "Neighbour"));
}
